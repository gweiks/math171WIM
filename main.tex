...
\begin{definition}
Set $C_1 = [0,1]$ and $C_{n+1} = T(C_n)$ for $n \ge 1$. We will refer to this as the Cantor sequence. The Cantor set is
\[
...
\begin{lemma}\
    For each $n \geq 1$, the set $C_n$ is a disjoint union of $2^n$ closed intervals, each of length $3^{-n}$. Moreover, $C_{n+1} \subset C_n$.
\end{lemma}
